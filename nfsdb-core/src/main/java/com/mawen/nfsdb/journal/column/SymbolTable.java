...
import com.mawen.nfsdb.journal.exceptions.JournalInvalidSymbolValueException;
...
public class SymbolTable implements Closeable {
	...
	public static final String DATA_FILE_SUFFIX = ".symd";
	public static final String INDEX_FILE_SUFFIX = ".symi";
	public static final String HASH_INDEX_FILE_SUFFIX = ".symr";
